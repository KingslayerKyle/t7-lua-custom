...
LUI.createMenu.T7Hud_zm_factory = function ( controller )
	...
	self.DummyFont3:setTTF( "fonts/skorzhen.ttf" )
	...
	self.BubbleGumPackInGame.BubbleGumPack.Black:setAlpha( 0.64 )
	self.BubbleGumPackInGame.BubbleGumPack.BubbleGumPackNameTextBox:setTTF( "fonts/dinnext_regular.ttf" )
	self.BubbleGumPackInGame.BubbleGumPack.BubbleGumPackLabel:setTTF( "fonts/dinnext_regular.ttf" )
	self.BubbleGumPackInGame.BubbleGumPack.BubbleGumPackLabelStroke:setTTF( "fonts/dinnext_regular.ttf" )
	...
	self.GameTimeGroup.CurrentClockTime.TimeElasped:setTTF( "fonts/dinnext_regular.ttf" )
	self.GameTimeGroup.CurrentClockTime.GameTimer:setTTF( "fonts/dinnext_regular.ttf" )
	...
	self.GameTimeGroup.SurviveTime.TimeElasped:setTTF( "fonts/dinnext_regular.ttf" )
	self.GameTimeGroup.SurviveTime.GameTimer:setTTF( "fonts/dinnext_regular.ttf" )
	self.GameTimeGroup.Last5RoundTime.TimeElasped:setTTF( "fonts/dinnext_regular.ttf" )
	self.GameTimeGroup.Last5RoundTime.GameTimer:setTTF( "fonts/dinnext_regular.ttf" )
	self.GameTimeGroup.QuestTime:setLeftRight( true, false, 0, 128 )
	self.GameTimeGroup.QuestTime:setTopBottom( true, false, 0, 96 )
	self.GameTimeGroup.QuestTime.TimeElasped:setTTF( "fonts/dinnext_regular.ttf" )
	self.GameTimeGroup.QuestTime.GameTimer:setTTF( "fonts/dinnext_regular.ttf" )
