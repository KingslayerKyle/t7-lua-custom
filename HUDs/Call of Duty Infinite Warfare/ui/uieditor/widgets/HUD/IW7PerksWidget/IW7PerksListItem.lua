CoD.IW7PerksListItem = InheritFrom( LUI.UIElement )
CoD.IW7PerksListItem.new = function ( menu, controller )
	...
	self:setClass( CoD.IW7PerksListItem )
	self.id = "IW7PerksListItem"
	self.soundSet = "default"
	self:setLeftRight( true, false, 0, 26 )
	self:setTopBottom( true, false, 0, 26 )
	
	self.GlowOblueOver = LUI.UIImage.new()
	self.GlowOblueOver:setLeftRight( true, false, -7.51 - 3, 43.51 + 3 )
	self.GlowOblueOver:setTopBottom( true, false, -36.85 - 3, 69.85 + 3 )
	...
	self.GlowBlueOver0:setLeftRight( true, false, 11.49 - 3, 24.51 + 3 )
	self.GlowBlueOver0:setTopBottom( true, false, -36.85 - 3, 69.85 + 3 )
	...
	self.GlowOrangeOver1:setLeftRight( true, false, -7.51 - 3, 43.51 + 3 )
	self.GlowOrangeOver1:setTopBottom( true, false, -36.85 - 3, 69.85 + 3 )
	...
	self.Lightning:setLeftRight( true, false, -57.5 - 3, 93.5 + 3 )
	self.Lightning:setTopBottom( true, false, -81 - 3, 63 + 3 )
		...
		Enabled = {
			...
			Intro = function ()
				...
				local GlowBlueOver0IntroTransitionStage2 = function ( element, event )
					...
					element:setLeftRight( true, false, 11.49 - 3, 24.51 + 3 )
					element:setTopBottom( true, false, -36.85 - 3, 69.85 + 3 )
