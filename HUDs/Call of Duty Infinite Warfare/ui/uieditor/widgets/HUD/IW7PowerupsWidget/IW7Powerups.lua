...
CoD.PowerUps.ClientFieldNames = {
	{
		...
		material = RegisterMaterial( "zm_powerup_instakill" )
	},
	{
		clientFieldName = "powerup_double_points",
		material = RegisterMaterial( "zm_powerup_double_cash" ),
		z_material = RegisterMaterial( "specialty_doublepoints_zombies_blue" )
	},
	{
		clientFieldName = "powerup_fire_sale",
		material = RegisterMaterial( "zm_powerup_fire_sale" )
	},
	{
	...
	},
	{
		...
		material = RegisterMaterial( "zm_powerup_max_ammo" )
	},
	{
...
LUI.createMenu.PowerUpsArea = function ( controller )
	...
	self.scaleContainer:setLeftRight( true, true, 0, -130 )
	self.scaleContainer:setTopBottom( true, true, 25, 0 )
