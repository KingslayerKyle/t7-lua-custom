require( "ui.uieditor.widgets.HUD.IW7ScoreWidget.IW7ClientScore" )
require( "ui.uieditor.widgets.HUD.IW7ScoreWidget.IW7PlusPointsContainer" )
require( "ui.uieditor.widgets.HUD.IW7ScoreWidget.IW7SelfScore" )
...
local CreateNewPlusPointsElement = function ( element, score, controller, menu, small, table )
	...
	local newPlusPointsElement = CoD.IW7PlusPointsContainer.new( menu, controller )
...
CoD.IW7ScoreContainer = InheritFrom( LUI.UIElement )
CoD.IW7ScoreContainer.new = function ( menu, controller )
	...
	self:setClass( CoD.IW7ScoreContainer )
	self.id = "IW7ScoreContainer"
	...
	self.ListingUser:setWidgetType( CoD.IW7SelfScore )
	...
	self.ZMScrPlusPoints0 = CoD.IW7PlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints0:setLeftRight( true, false, 40, 0 )
	self.ZMScrPlusPoints0:setTopBottom( false, true, -277.5, 0 )
	self:addElement( self.ZMScrPlusPoints0 )

	self.ZMScrPlusPoints1 = CoD.IW7PlusPointsContainer.new( menu, controller )
	...
	self.ZMScrPlusPoints2 = CoD.IW7PlusPointsContainer.new( menu, controller )
	...
	self.ZMScrPlusPoints3 = CoD.IW7PlusPointsContainer.new( menu, controller )
