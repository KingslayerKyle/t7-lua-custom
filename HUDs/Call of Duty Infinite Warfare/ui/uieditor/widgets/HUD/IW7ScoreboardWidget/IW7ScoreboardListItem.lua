...
CoD.IW7ScoreboardListItem.new = function ( menu, controller )
	...
	self.Gamertag:linkToElementModel( self, "clientNum", true, function ( model )
		if Engine.GetModelValue( model ) then
			self.Gamertag:setText( Engine.Localize( GetClientName( controller, Engine.GetModelValue( model ) ) ) )
		end
	end )
	...
	self.ScoreColumn1:linkToElementModel( self, "clientNumScoreInfoUpdated", true, function ( model )
		if Engine.GetModelValue( model ) then
			self.ScoreColumn1:setText( Engine.Localize( GetScoreboardPlayerScoreColumn( controller, 0, Engine.GetModelValue( model ) ) ) )
		end
	end )
	...
	self.ScoreColumn2:linkToElementModel( self, "clientNumScoreInfoUpdated", true, function ( model )
		if Engine.GetModelValue( model ) then
			self.ScoreColumn2:setText( Engine.Localize( GetScoreboardPlayerScoreColumn( controller, 1, Engine.GetModelValue( model ) ) ) )
		end
	end )
	...
	self.ScoreColumn3:linkToElementModel( self, "clientNumScoreInfoUpdated", true, function ( model )
		if Engine.GetModelValue( model ) then
			self.ScoreColumn3:setText( Engine.Localize( GetScoreboardPlayerScoreColumn( controller, 4, Engine.GetModelValue( model ) ) ) )
		end
	end )
	...
	self.ScoreColumn4:linkToElementModel( self, "clientNumScoreInfoUpdated", true, function ( model )
		if Engine.GetModelValue( model ) then
			self.ScoreColumn4:setText( Engine.Localize( GetScoreboardPlayerScoreColumn( controller, 3, Engine.GetModelValue( model ) ) ) )
		end
	end )
	...
	self.ScoreColumn5:linkToElementModel( self, "clientNumScoreInfoUpdated", true, function ( model )
		if Engine.GetModelValue( model ) then
			self.ScoreColumn5:setText( Engine.Localize( GetScoreboardPlayerScoreColumn( controller, 2, Engine.GetModelValue( model ) ) ) )
		end
	end )
	...
	self.PingText:linkToElementModel( self, "ping", true, function ( model )
		if Engine.GetModelValue( model ) then
			if Engine.GetModelValue( model ) > 1 then
				self.PingText:setText( Engine.Localize( "Ping: " .. Engine.GetModelValue( model ) ) )
			end
		end
	end )
