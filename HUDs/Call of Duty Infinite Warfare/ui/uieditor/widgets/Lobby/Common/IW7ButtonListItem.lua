...
CoD.IW7ButtonListItem.new = function ( menu, controller )
	...
	self.btnDisplayText:linkToElementModel( self, "displayText", true, function ( model ) 
		if Engine.GetModelValue( model ) then
			self.btnDisplayText:setText( Engine.Localize( LocalizeToUpperString( Engine.GetModelValue( model ) ) ) )
		end
	end )
	...
	self.btnDisplayTextStroke:linkToElementModel( self, "displayText", true, function ( model )
		if Engine.GetModelValue( model ) then
			self.btnDisplayTextStroke:setText( Engine.Localize( LocalizeToUpperString( Engine.GetModelValue( model ) ) ) )
		end
	end )
