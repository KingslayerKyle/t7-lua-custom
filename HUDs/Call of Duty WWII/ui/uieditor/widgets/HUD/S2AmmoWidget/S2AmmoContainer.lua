...
CoD.S2AmmoContainer.new = function ( menu, controller )
	...
	self.WeaponNameShadow:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "currentWeapon.weaponName" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			self.WeaponNameShadow:setText( Engine.Localize( Engine.GetModelValue( modelRef ) ) )
		end
	end )
	...
	self.BGBPromptShadow:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "bgb_display" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
	...
	self.BGBPrompt:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "bgb_display" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			if Engine.GetModelValue( modelRef ) == 1 then
	...
	self.MuleKickIcon:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "S2.MuleKick" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			if Engine.GetModelValue( modelRef ) == 1 then
