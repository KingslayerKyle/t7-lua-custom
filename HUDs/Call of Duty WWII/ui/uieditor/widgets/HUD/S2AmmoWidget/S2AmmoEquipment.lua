...
CoD.S2AmmoEquipment.new = function ( menu, controller )
	...
	self.LethalCountTextShadow:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "currentPrimaryOffhand.primaryOffhandCount" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			self.LethalCountTextShadow:setText( Engine.Localize( Engine.GetModelValue( modelRef ) ) )
		end
	end )
	...
	self.TacticalCountTextShadow:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "currentSecondaryOffhand.secondaryOffhandCount" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			if Engine.GetModelValue( Engine.GetModel( Engine.GetModelForController( controller ), "CurrentSecondaryOffhand.secondaryOffhand" ) ) ~= nil then
				if Engine.GetModelValue( Engine.GetModel( Engine.GetModelForController( controller ), "CurrentSecondaryOffhand.secondaryOffhand" ) ) == "blacktransparent" then
					...
					self.TacticalCountTextShadow:setText( Engine.Localize( Engine.GetModelValue( modelRef ) ) )
				end
			end
		end
	end )
	...
	self.SpecialImageBG:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmhud.swordEnergy" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
	...
	self.SpecialImageBG2:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmhud.swordEnergy" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			if Engine.GetModelValue( modelRef ) < 1 then
	...
	self.SpecialMeterBGGlow:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmhud.swordEnergy" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			if Engine.GetModelValue( modelRef ) < 1 then
				self.SpecialMeterBGGlow:setImage( RegisterImage( "blacktransparent" ) )
			else
	...
	self.DpadIconMineCountTextShadow:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "hudItems.actionSlot3ammo" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			if Engine.GetModelValue( modelRef ) > 0 then
				self.DpadIconMineCountTextShadow:setText( Engine.Localize( Engine.GetModelValue( modelRef ) ) )
			else
				self.DpadIconMineCountTextShadow:setText( Engine.Localize( "" ) )
			end
		end
