...
CoD.S2AmmoInfo.new = function ( menu, controller )
	...
	self.AmmoClipShadow:subscribeToGlobalModel( controller, "CurrentWeapon", "ammoInClip", function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			self.AmmoClipShadow:setText( Engine.Localize( Engine.GetModelValue( modelRef ) ) )
		end
	end )
	...
	self.AmmoClipDWShadow:subscribeToGlobalModel( controller, "CurrentWeapon", "ammoInDWClip", function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			self.AmmoClipDWShadow:setText( Engine.Localize( Engine.GetModelValue( modelRef ) ) )
		end
	end )
	...
	self.AmmoStockShadow:subscribeToGlobalModel( controller, "CurrentWeapon", "ammoStock", function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			self.AmmoStockShadow:setText( Engine.Localize( Engine.GetModelValue( modelRef ) ) )
		end
	end )
