...
CoD.S2Round.new = function ( menu, controller )
	...
	self.RoundsTextShadow:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "gameScore.roundsPlayed" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			self.RoundsTextShadow:setText( Engine.Localize( Engine.GetModelValue( modelRef ) - 1 ) )
		end
	end )
	...
	self.RoundsText:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "gameScore.roundsPlayed" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			self.RoundsText:setText( Engine.Localize( Engine.GetModelValue( modelRef ) - 1 ) )
		end
	end )
