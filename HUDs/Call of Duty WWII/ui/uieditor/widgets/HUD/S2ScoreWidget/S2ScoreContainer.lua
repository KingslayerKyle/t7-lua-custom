require( "ui.uieditor.widgets.HUD.S2ScoreWidget.S2ClientScore" )
require( "ui.uieditor.widgets.HUD.S2ScoreWidget.S2PlusPointsContainer" )
require( "ui.uieditor.widgets.HUD.S2ScoreWidget.S2SelfScore" )
...
local CreateNewPlusPointsElement = function ( element, score, controller, menu, small, table )
	...
	local newPlusPointsElement = CoD.S2PlusPointsContainer.new( menu, controller )
...
CoD.S2ScoreContainer = InheritFrom( LUI.UIElement )
CoD.S2ScoreContainer.new = function ( menu, controller )
	...
	self:setClass( CoD.S2ScoreContainer )
	self.id = "S2ScoreContainer"
	...
	self.ListingUser:setWidgetType( CoD.S2SelfScore )
	...
	self.Listing2 = CoD.S2ClientScore.new( menu, controller )
	...
	self.Listing3 = CoD.S2ClientScore.new( menu, controller )
	...
	self.Listing4 = CoD.S2ClientScore.new( menu, controller )
	...
	self.ZMScrPlusPoints0 = CoD.S2PlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints0:setLeftRight( true, false, 125, 0 )
	self.ZMScrPlusPoints0:setTopBottom( false, true, -177.5, 0 )
	self:addElement( self.ZMScrPlusPoints0 )
	
	self.ZMScrPlusPoints1 = CoD.S2PlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints1:setLeftRight( true, false, 100, 0 )
	self.ZMScrPlusPoints1:setTopBottom( false, true, -230, 0 )
	self:addElement( self.ZMScrPlusPoints1 )
	
	self.ZMScrPlusPoints2 = CoD.S2PlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints2:setLeftRight( true, false, 100, 0 )
	self.ZMScrPlusPoints2:setTopBottom( false, true, -293, 0 )
	self:addElement( self.ZMScrPlusPoints2 )
	
	self.ZMScrPlusPoints3 = CoD.S2PlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints3:setLeftRight( true, false, 100, 0 )
	self.ZMScrPlusPoints3:setTopBottom( false, true, -356, 0 )
