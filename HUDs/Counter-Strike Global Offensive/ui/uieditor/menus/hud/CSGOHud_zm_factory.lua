...
-- CSGO Widgets
require( "ui.uieditor.widgets.HUD.CSGOAmmoWidget.CSGOAmmoContainer" )
require( "ui.uieditor.widgets.HUD.CSGOPerksWidget.CSGOPerksContainer" )
require( "ui.uieditor.widgets.HUD.CSGORoundWidget.CSGORound" )
require( "ui.uieditor.widgets.HUD.CSGOScoreWidget.CSGOScoreContainer" )
...
LUI.createMenu.T7Hud_zm_factory = function ( controller )
	...
	self.DummyFont1:setTTF( "fonts/stratum2bold.ttf" )
	self.DummyFont1:setText( "DummyFont" )
	self:addElement( self.DummyFont1 )
	
	self.ZMPerksContainerFactory = CoD.CSGOPerksContainer.new( self, controller )
