...
local SetWeaponImages = function ( element, modelRef )
	local weaponName = Engine.GetModelValue( modelRef )
	...
	if weaponName then
		...
		if CoD.CSGOAmmoWeaponImages then
			for key, value in pairs( CoD.CSGOAmmoWeaponImages ) do
				if Engine.GetModelValue( modelRef ) == key then
...
local SetWeaponUpgradeImages = function ( element, modelRef )
	if Engine.GetModelValue( modelRef ) then
		if Engine.GetModelValue( modelRef ):find( "_upgraded" )
		or Engine.GetModelValue( modelRef ):sub( -3 ) == "_up" then
...
local SetAATImages = function ( element, modelRef )
	if Engine.GetModelValue( modelRef ) then
		if Engine.GetModelValue( modelRef ) == "zm_aat_blast_furnace" then
			element:setImage( RegisterImage( "t7_icon_zm_aat_blast_furnace" ) )

		elseif Engine.GetModelValue( modelRef ) == "zm_aat_dead_wire" then
			element:setImage( RegisterImage( "t7_icon_zm_aat_dead_wire" ) )

		elseif Engine.GetModelValue( modelRef ) == "zm_aat_fire_works" then
			element:setImage( RegisterImage( "t7_icon_zm_aat_fire_works" ) )

		elseif Engine.GetModelValue( modelRef ) == "zm_aat_thunder_wall" then
			element:setImage( RegisterImage( "t7_icon_zm_aat_thunder_wall" ) )

		elseif Engine.GetModelValue( modelRef ) == "zm_aat_turned" then
...
local SetCurrentWeaponBG = function ( element )
...
CoD.CSGOAmmoEquipment.new = function ( menu, controller )
	...
	self.DpadIconMineImage:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "hudItems.showDpadRight" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
	...
	self.CurrentWeaponBG:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "currentWeapon.viewmodelWeaponName" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetCurrentWeaponBG( self.CurrentWeaponBG )
		end
	end )
	self.CurrentWeaponBG:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_first_weapon" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetCurrentWeaponBG( self.CurrentWeaponBG )
		end
	end )
	self.CurrentWeaponBG:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_second_weapon" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetCurrentWeaponBG( self.CurrentWeaponBG )
		end
	end )
	self.CurrentWeaponBG:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_third_weapon" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetCurrentWeaponBG( self.CurrentWeaponBG )
		end
	end )
	...
	self.FirstWeaponPrompt:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_first_weapon" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
	...
	self.FirstWeaponUpgradeImage:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_first_weapon" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetWeaponUpgradeImages( self.FirstWeaponUpgradeImage, modelRef )
		end
	end )
	...
	self.FirstWeaponImage:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_first_weapon" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetWeaponImages( self.FirstWeaponImage, modelRef )
		end
	end )
	...
	self.FirstWeaponAATImage:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_first_weapon_aat" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetAATImages( self.FirstWeaponAATImage, modelRef )
		end
	end )
	...
	self.SecondWeaponPrompt:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_second_weapon" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			if Engine.GetModelValue( modelRef ) == "none" then
				self.SecondWeaponPrompt:setText( Engine.Localize( "" ) )
			else
	...
	self.SecondWeaponUpgradeImage:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_second_weapon" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetWeaponUpgradeImages( self.SecondWeaponUpgradeImage, modelRef )
		end
	end )
	...
	self.SecondWeaponImage:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_second_weapon" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetWeaponImages( self.SecondWeaponImage, modelRef )
		end
	end )
	...
	self.SecondWeaponAATImage:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_second_weapon_aat" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetAATImages( self.SecondWeaponAATImage, modelRef )
		end
	end )
	...
	self.ThirdWeaponPrompt:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_third_weapon" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			if Engine.GetModelValue( modelRef ) == "none" then
				self.ThirdWeaponPrompt:setText( Engine.Localize( "" ) )
			else
	...
	self.ThirdWeaponUpgradeImage:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_third_weapon" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetWeaponUpgradeImages( self.ThirdWeaponUpgradeImage, modelRef )
		end
	end )
	...
	self.ThirdWeaponImage:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_third_weapon" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetWeaponImages( self.ThirdWeaponImage, modelRef )
		end
	end )
	...
	self.ThirdWeaponAATImage:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "csgo_third_weapon_aat" ), function ( modelRef )
		if Engine.GetModelValue( modelRef ) then
			SetAATImages( self.ThirdWeaponAATImage, modelRef )
		end
	end )
