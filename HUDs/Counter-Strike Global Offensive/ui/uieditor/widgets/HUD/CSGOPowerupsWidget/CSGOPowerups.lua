...
CoD.PowerUps.ClientFieldNames = {
	{
		...
		material = RegisterMaterial( "csgo_powerup_instakill" )
	},
	{
		clientFieldName = "powerup_double_points",
		material = RegisterMaterial( "csgo_powerup_doublepoints" ),
		z_material = RegisterMaterial( "specialty_doublepoints_zombies_blue" )
	},
	{
		clientFieldName = "powerup_fire_sale",
		material = RegisterMaterial( "csgo_powerup_firesale" )
	},
	{
	...
	},
	{
		...
		material = RegisterMaterial( "csgo_powerup_deathmachine" )
	},
	{
...
LUI.createMenu.PowerUpsArea = function ( controller )
	...
	self.scaleContainer:setLeftRight( true, true, 0, -20 )
	self.scaleContainer:setTopBottom( true, true, 20, 0 )
	...
	for index = 1, #CoD.PowerUps.ClientFieldNames, 1 do
		...
		powerUp:setLeftRight( false, true, - CoD.PowerUps.IconSize, 0 )
		powerUp:setTopBottom( true, false, 0, CoD.PowerUps.IconSize )
		...
		powerUp.powerUpIcon:setTopBottom( true, true, 0, 0 )
		powerUp.powerUpIcon:setAlpha( 0 )
		powerUp:addElement( powerUp.powerUpIcon )
		
		powerUp.upgradePowerUpIcon = LUI.UIImage.new()
		powerUp.upgradePowerUpIcon:setLeftRight( true, true, 0, 0 )
		powerUp.upgradePowerUpIcon:setTopBottom( true, true, 0, 0 )
	...
	for index = 1, #CoD.PowerUps.ClientFieldNames, 1 do
		...
		if powerUp.powerUpId ~= nil then
			if not activePowerUps then
				...
				rightOffset = activePowerUps - CoD.PowerUps.IconSize - CoD.PowerUps.Spacing
			end

			leftOffset = rightOffset - CoD.PowerUps.IconSize
			powerUp:beginAnimation( "move", CoD.PowerUps.MOVING_DURATION )
			powerUp:setLeftRight( false, true, leftOffset, rightOffset )
			activePowerUps = rightOffset
		end
	end
end
