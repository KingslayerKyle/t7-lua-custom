require( "ui.uieditor.widgets.HUD.CSGOScoreWidget.CSGOClientScore" )
require( "ui.uieditor.widgets.HUD.CSGOScoreWidget.CSGOPlusPointsContainer" )
require( "ui.uieditor.widgets.HUD.CSGOScoreWidget.CSGOSelfScore" )
...
local CreateNewPlusPointsElement = function ( element, score, controller, menu, small, table )
	...
	local newPlusPointsElement = CoD.CSGOPlusPointsContainer.new( menu, controller )
	...
	if small then
		newPlusPointsElement:setScale( 0 )
	end
...
CoD.CSGOScoreContainer = InheritFrom( LUI.UIElement )
CoD.CSGOScoreContainer.new = function ( menu, controller )
	...
	self:setClass( CoD.CSGOScoreContainer )
	self.id = "CSGOScoreContainer"
	...
	self.ListingUser:setWidgetType( CoD.CSGOSelfScore )
	...
	self.Listing2 = CoD.CSGOClientScore.new( menu, controller )
	self.Listing2:setLeftRight( true, false, 0, 0 )
	self.Listing2:setTopBottom( true, false, 0, 0 )
	...
	self.Listing3 = CoD.CSGOClientScore.new( menu, controller )
	self.Listing3:setLeftRight( true, false, 93, 0 )
	self.Listing3:setTopBottom( true, false, 0, 0 )
	...
	self.Listing4 = CoD.CSGOClientScore.new( menu, controller )
	self.Listing4:setLeftRight( true, false, 129, 0 )
	self.Listing4:setTopBottom( true, false, 0, 0 )
	...
	self.ZMScrPlusPoints0 = CoD.CSGOPlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints0:setLeftRight( true, false, 30, 0 )
	self.ZMScrPlusPoints0:setTopBottom( true, false, 180, 0 )
	self:addElement( self.ZMScrPlusPoints0 )
	
	self.ZMScrPlusPoints1 = CoD.CSGOPlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints1:setLeftRight( false, false, 0, 0 )
	self.ZMScrPlusPoints1:setTopBottom( false, false, 0, 0 )
	self:addElement( self.ZMScrPlusPoints1 )
	
	self.ZMScrPlusPoints2 = CoD.CSGOPlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints2:setLeftRight( false, false, 0, 0 )
	self.ZMScrPlusPoints2:setTopBottom( false, false, 0, 0 )
	self:addElement( self.ZMScrPlusPoints2 )
	
	self.ZMScrPlusPoints3 = CoD.CSGOPlusPointsContainer.new( menu, controller )
	self.ZMScrPlusPoints3:setLeftRight( false, false, 0, 0 )
	self.ZMScrPlusPoints3:setTopBottom( false, false, 0, 0 )
